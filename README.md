...
- `multithreading` (boolean, default: `false`): Allow multiple threads to access the database. This is only relevant when using [`node.js worker_threads`](https://nodejs.org/api/worker_threads.html)
